    ...
    <section className="w-full min-h-screen py-20 px-6">
      <div className="max-w-6xl mx-auto grid lg:grid-cols-1 gap-12 text-left">
        <div>
          ...
          <p className="text-gray-600 text-lg leading-relaxed mb-6"> Mam 12 lat doświadczenia w projektowaniu materiałów drukowanych i digitalowych (e-commerce, kampanie outdoorowe, skład publikacji). Tworzę również responsywne strony internetowe oparte na React. W 2013 roku ukończyłem studia magisterskie na kierunku Grafika na Wydziale Sztuk Pięknych UMK w Toruniu, uzyskując tytuł magistra sztuki.
