...
p.nominalBounds = new cjs.Rectangle(0,0,246,304);
...
p.nominalBounds = new cjs.Rectangle(0,0,246,304);// helper functions:
...
}).prototype = getMCSymbolPrototype(lib.hero3_1, new cjs.Rectangle(0,0,246,304), null);
...
}).prototype = getMCSymbolPrototype(lib.hero2_1, new cjs.Rectangle(0,0,246,304), null);
...
}).prototype = getMCSymbolPrototype(lib.hero1_1, new cjs.Rectangle(0,0,246,304), null);
...
if (reversed == null) { reversed = false; }
	...
	this.btn.name = "btn";
	this.btn.setTransform(120.05,375.9,1,1,0,0,0,46.6,12.8);
	...
	this.hero1.setTransform(120.1,180.4,0.8962,0.8962,0,0,0,121,152.2);
	...
	this.hero2.setTransform(120.05,178.25,0.8987,0.8987,0,0,0,132.4,149.3);
	...
	this.hero3.setTransform(120.05,172.25,0.8889,0.8889,0,0,0,128.3,141.8);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"./bg.jpg?1610373434090", id:"bg"},
		{src:"./hero1.png?1610373434090", id:"hero1"},
		{src:"./hero2.png?1610373434090", id:"hero2"},
		{src:"./hero3.png?1610373434090", id:"hero3"}
	],
	preloads: []
};
